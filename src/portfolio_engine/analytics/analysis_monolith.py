...
- Market regime detection (regime-conditioned analysis)
- Type-specific thresholds
- Issue analysis (criticità)
- False diversification detection
- Senior Architect analysis helpers

NOTE: temporal decomposition and resilience scoring have been moved to
portfolio_analysis/ submodule but are re-exported here for backward compatibility.
"""
...
from portfolio_engine.data.definitions.crisis import KNOWN_CRISIS_PERIODS, get_crisis_periods_dict


# ================================================================================
# Import regime detection from specialized module
from portfolio_engine.analytics.regime import (
    REGIME_CRITERIA,
...
# ================================================================================
# Import temporal and resilience from portfolio_analysis submodule
